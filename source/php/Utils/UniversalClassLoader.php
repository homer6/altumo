...
/**
* 
* This class has been modified from its original version to support namespaces 
* that don't have the folder name.  See Symfony\Component\ClassLoader::loadClass()
* 
* 
* 
* Symfony 1.4 ProjectConfiguration Usage: 

    require_once dirname(__FILE__).'/../lib/vendor/symfony/lib/autoload/sfCoreAutoload.class.php';

    //symfony 1 autoloader
        sfCoreAutoload::register();

    //symfony 2 autoloader (for classes within namespaces)
        require_once __DIR__ . '/../lib/vendor/altumo/source/php/UniversalClassLoader.php';
        $loader = new Symfony\Component\ClassLoader\UniversalClassLoader();
        $loader->registerNamespaces(array(
            'Altumo' => __DIR__.'/../lib/vendor/altumo/source/php'
        ));
        $loader->register();
