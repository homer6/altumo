 ...
 * 
 * This file has been adapted from the symfony 1.4 project. It has been modified
 * to reduce dependencies on symfony and provide clearer comments and return
 ...
 *
 * $files = \Altumo\Utils\Finder::type('file')->name('*.php')->in(.);
 *
...
class Finder{
    ...
    *
    * @param integer $level                 //max number of directory levels to 
    *                                         descend
    * @return \Altumo\Utils\Finder
    */
    ...
    *
    * @param  string $name                  //directory or file or any (for 
    ...
    */
    ...
    /**
    * Converts the output of func_get_args() to an array.
    * 
